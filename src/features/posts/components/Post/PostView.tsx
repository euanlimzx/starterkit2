...
export const RetweetPostView = ({
  post, //this will have to change to retweeted post, which will likely have the same properties as a regular post
  //retweetedPost,
  hideActions,
  containerProps,
}: PostViewProps): JSX.Element => {
  ...
  return (
    <Box>
      <Text textStyle="subhead-2" color="brand.secondary.500" my={2}>
        Euan retweeted
        {/* change this to match a dynamic username handle */}
      </Text>
      <Box
